 ...
 */
    ...
    private final WatchServiceModel model;
     ...
     */
    public WatchServiceController() throws IOException {
			this.watcher = FileSystems.getDefault().newWatchService();
			this.model = new WatchServiceModel();
			this.keys = model.getFilesystemKeys();
			this.recursive = false;
    };/*
    Path dir, boolean recursive) throws IOException {
        this.watcher = FileSystems.getDefault().newWatchService();
