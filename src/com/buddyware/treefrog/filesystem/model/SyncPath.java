...
public final class SyncPath {
		...
		public final synchronized Path getPath() { return mPath; }
		public final synchronized SyncType getSyncType() { return mSyncType; }
		public final synchronized Path getRelativePath() { return mRelativePath; }
		public final synchronized long getQueuedTime() { return mQueuedTime; }
		public final synchronized boolean isFile() { return !Files.isDirectory(mPath); }
		public final synchronized int hashCode() { return mHash; }
