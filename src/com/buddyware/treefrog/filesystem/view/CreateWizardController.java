...
public class CreateWizardController {
	...
	@FXML StackPane wizardStackPane;
	
	@FXML ComboBox comboSyncTargets;
	
	@FXML Button buttonSyncToCloud;
	
	@FXML Button buttonSyncToComputer;
	
	@FXML Button buttonLeft;
	
	@FXML Button buttonMiddle;
    ...
    private void setupPageTwo (boolean localSetup) {
    	...
    	if (!localSetup) {
    		...
    		initComboBox(
    			FXCollections.observableArrayList(volList)
    			);
    	}
    }
